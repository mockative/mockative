...
fun <R, F> whenInvoking(
    instance: Any,
    function: F
): WhenInvoking0Builder<R> where F : () -> R, F : KFunction<R> {
    return whenInvoking0(instance, function)
}

fun <R, F> whenInvoking0(
    instance: Any,
    function: F
): WhenInvoking0Builder<R> where F : () -> R, F : KFunction<R> {
    return WhenInvoking0Builder(instance.asMockable(), function)
}

class WhenInvoking0Builder<R>(
